...
class GameMenu():
    def __init__(self, display):
        ...
        y = int(self.gameScreen.get_height()/4)
        self.options.append(Option(x, y + (height * 0) + (margin * 0), width, height, "Me VS. Me Pong", (0, 0, 0)))
        self.options.append(Option(x, y + (height * 2) + (margin * 0), width, height, "Begin User Game", (253, 0, 6)))
        self.options.append(Option(x, y + (height * 3) + (margin * 1), width, height, "Begin AI Game", (253, 0, 6)))
        #(0, 191, 255)
            ...
            for o in self.options:
                if o.collide(mousePos[0], mousePos[1]):
                    if o.text == "Begin User Game":
                        ...
                        print "unkown button selected from menu: "+str(o)
